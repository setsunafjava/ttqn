...
(function(a){
    a.fn.number_slideshow=function(p){
        ...
        var t=p&&p.slideshow_window_height?p.slideshow_window_height:"330";
        ...
        F.show();
        F.find("ul:first").children("li").children("a").children("div").children("img").css("width",s).css("height",t);		
        ...
        var img = new Image();
        img.src = F.find("ul:first").children("li").eq(0).children("a").children("div").children("img").attr("src");
        img.onload = function(){
            if(first == false){
                first = true;
                play();
        ...
        function s_s_ul(a,b,c,d,e,f,g,h,i,l_g){
            ...
            if(H == 'enable'){
                a.children("li").each(function(i){
                     a.children("li").eq(i).append("<p>"+a.children("li").eq(i).children("a").children("div").children("img").attr("alt")+"</p>");
                });
            }
