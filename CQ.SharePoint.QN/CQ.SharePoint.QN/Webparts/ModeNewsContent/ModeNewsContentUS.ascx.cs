        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if(!IsPostBack)
            {
                try
                {
                    ...
                    {
                        lblHeaderTinhUy.Text = Convert.ToString(tinhUyNewsTable.Rows[0][FieldsName.NewsRecord.English.ShortContent]);
                    ...
                    {
                        lblHeaderHoiDongNhanDan.Text = Convert.ToString(hoiDongNhanDanNewsTable.Rows[0][FieldsName.NewsRecord.English.ShortContent]);
                    ...
                    {
                        lblHeaderUyBanNhanDan.Text = Convert.ToString(uyBanNhanDanNewsTable.Rows[0][FieldsName.NewsRecord.English.ShortContent]);
