...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ShowGalleryUS.ascx.cs"
    Inherits="CQ.SharePoint.QN.Webparts.ShowGalleryUS" %>
<div class="ad-gallery" id="gallery">
    ...
    <div class="ad-nav">
        <div class="ad-back" style="opacity: 0.6;">
        </div>
        <div class="ad-thumbs">
        ...
        <div class="ad-forward" style="opacity: 0.6;">
        </div>
    </div>
</div>
<style type="text/css">
    ...
    .ad-gallery .ad-image-wrapper .ad-prev, .ad-gallery .ad-image-wrapper .ad-next
    {
        ...
        background: url(/QNResources/non-existing.jpg)\9;
    }
    .ad-gallery .ad-image-wrapper .ad-prev .ad-prev-image, .ad-gallery .ad-image-wrapper .ad-next .ad-next-image
    {
        background: url(/QNResources/ad_prev.png);
        width: 30px;
        height: 30px;
        display: none;
        position: absolute;
    ...
    {
        background: url(/QNResources/ad_next.png);
        width: 30px;
        height: 30px;
        right: 0;
        left: auto;
    ...
    .ad-gallery .ad-image-wrapper .ad-image .ad-image-description
    {
        ...
        width: 100%;
        z-index: 2;
        background: url(/QNResources/opa75.png);
        color: #000;
    }
    * html .ad-gallery .ad-image-wrapper .ad-image .ad-image-description
    {
        background: none;
        filter: progid:DXImageTransform.Microsoft.AlphaImageLoader (enabled=true, sizingMethod=scale, src= '/QNResources/opa75.png' );
    }
    ...
    /* IE 6 doesn't like height: 100% */* html .ad-gallery .ad-forward, .ad-gallery .ad-back
    {
        height: 100px;
    }
    .ad-gallery .ad-back
    {
        ...
        width: 13px;
        display: block;
        background: url(/QNResources/ad_scroll_back.png) 0px 22px no-repeat;
    }
    .ad-gallery .ad-forward
    {
        ...
        right: -20px;
        width: 13px;
        background: url(/QNResources/ad_scroll_forward.png) 0px 22px no-repeat;
    }
...
(function($) {
  $.fn.adGallery = function(options) {
    var defaults = { loader_image: '/QNResources/loader.gif',
                     start_at_index: 0,
